                        ...
                        <div class="card card-info">
                            ...
                            <?= form_open_multipart('admin/product/edit/'.$data['product_id'], ['class'=>'form-horizontal']) ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="_brand_" class="col-sm-3 col-form-label text-right">Brand</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="_brand_" class="form-control" id="_brand_" placeholder="Brand" value="<?= old('_brand_') ? old('_brand_') : $data['product_brand'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="_discount_" class="col-sm-3 col-form-label text-right">Discount</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="_discount_" class="form-control" id="_discount_" placeholder="Discount" value="<?= old('_discount_') ? old('_discount_') : $data['product_discount'] ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="_rating_" class="col-sm-3 col-form-label text-right">Rating</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="_rating_" class="form-control" id="_rating_" placeholder="Rating" value="<?= old('_rating_') ? old('_rating_') : $data['product_rating'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <?php
                                                        if (strpos($data['product_image'], "http") !== false) {
