                            ...
                            <?= form_open_multipart('admin/product/add', ['class'=>'form-horizontal']) ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="_brand_" class="form-control" id="_brand_" placeholder="Brand" value="<?= old('_brand_') ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="_discount_" class="form-control" id="_discount_" placeholder="Discount" value="<?= old('_discount_') ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="_rating_" class="form-control" id="_rating_" placeholder="Rating" value="<?= old('_rating_') ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <img src="<?= base_url('images/product/default.png')?>" id="img-preview" alt="Preview Image" class="img-thumbnail">
                                                </div>
                                                <div class="col-sm-9">
